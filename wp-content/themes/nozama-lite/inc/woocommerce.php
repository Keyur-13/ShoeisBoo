		...
		<div class="shop-actions <?php echo esc_attr( $actions_class ); ?>">
			...
			<div class="shop-action-results">
				...
				<div class="product-number">
					...
					<a href="<?php echo esc_url( add_query_arg( 'view', $first, $url ) ); ?>" class="<?php echo esc_attr( $classes['first'] ); ?>"><?php echo esc_html( $first ); ?></a>
					<a href="<?php echo esc_url( add_query_arg( 'view', $second, $url ) ); ?>" class="<?php echo esc_attr( $classes['second'] ); ?>"><?php echo esc_html( $second ); ?></a>
					<?php if ( apply_filters( 'nozama_lite_products_view_all', true ) ) : ?>
						<a href="<?php echo esc_url( add_query_arg( 'view', 'all', $url ) ); ?>" class="<?php echo esc_attr( $classes['all'] ); ?>"><?php esc_html_e( 'All', 'nozama-lite' ); ?></a>
					<?php endif; ?>
				</div>
			</div>
...
add_filter( 'term_link', 'nozama_lite_woocommerce_term_link', 10, 3 );
function nozama_lite_woocommerce_term_link( $termlink, $term, $taxonomy ) {
	...
	$user_posts_per_page    = (int) nozama_lite_woocommerce_loop_shop_per_page_view( $default_posts_per_page );
