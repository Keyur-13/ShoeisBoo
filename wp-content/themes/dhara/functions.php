...
define( 'DHARA_VERSION', '1.1.0' );

if ( ! function_exists( 'dhara_setup' ) ) {
	add_action( 'after_setup_theme', 'dhara_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function dhara_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'dhara' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'dhara' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in dhara_smart_content_width()
		 */
...
define('DHARA_THEME_URL','https://wpkoi.com/dhara-wpkoi-wordpress-theme/');
define('DHARA_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('DHARA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('DHARA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/dhara/reviews/?filter=5');
define('DHARA_DOCUMENTATION','https://wpkoi.com/docs/');
define('DHARA_FONT_AWESOME_LINK','https://wpkoi.com/docs/custom-icons/');
