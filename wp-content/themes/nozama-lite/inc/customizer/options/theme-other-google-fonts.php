<?php
	...
	$wp_customize->add_control( 'theme_local_google_fonts', array(
		...
		'description' => esc_html__( "When enabled, the theme's default Google fonts will be served by your server instead from Google's CDN. You may need to enable this option for GDPR compliance.", 'nozama-lite' ),
	) );
