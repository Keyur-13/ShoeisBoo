...
class VW_Automobile_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Automobile_Lite_About_Widget',
			__('VW About us', 'vw-automobile-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-automobile-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-automobile-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-automobile-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-automobile-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-automobile-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-automobile-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-automobile-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_automobile_lite_about_custom_load_widget() {
	register_widget( 'VW_Automobile_Lite_About_Widget' );
}
add_action( 'widgets_init', 'vw_automobile_lite_about_custom_load_widget' );