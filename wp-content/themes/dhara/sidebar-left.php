...
$navigation_active = ( 'nav-left-sidebar' == dhara_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php dhara_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * dhara_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'dhara_before_left_sidebar_content' );
		...
		/**
		 * dhara_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'dhara_after_left_sidebar_content' );
		?>
